    ...
    nodes: [
      {
        ...
        data: { name: "start", params: [], templateRef: null, templateVersion: null, upgradesAvailable: false },
        type: "start",
      },
      {
        id: "64cafb1706ca9f65f338ae3c",
        data: { name: "end", params: [], templateRef: null, templateVersion: null, upgradesAvailable: false },
        type: "end",
      },
      {

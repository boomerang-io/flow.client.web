                ...
                sortBy(members, ["userName"]).map((member) => (
                  <li className={styles.userListItem}>
                    ...
                    </div>
                    {
                      ...
                      isRemove ?
                      <div role="button" onClick={() => arrayHelpers.remove(determineMemberIndex(member.userId))} onKeyDown={(e: any) => isAccessibleEvent(e) && arrayHelpers.remove(determineMemberIndex(member.userId))} tabIndex={0} >
                        <SubtractAlt16 className={styles.actionIcon}/>
                      </div>
                      :
                      <div role="button" onClick={() => arrayHelpers.push(member)} onKeyDown={(e: any) => isAccessibleEvent(e) && arrayHelpers.push(member)} tabIndex={0} >

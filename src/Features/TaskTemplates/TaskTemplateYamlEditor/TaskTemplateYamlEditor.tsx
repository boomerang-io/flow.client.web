...
import { InlineNotification, Loading, notify, ToastNotification } from "@carbon/react";
...
export function TaskTemplateYamlEditor({
  ...
  const invalidateYaml = () => {
    queryClient.invalidateQueries(serviceUrl.getTaskTemplateYaml({ id: params.id, revision: params.version }));
  };

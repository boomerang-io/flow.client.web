...
import styles from "./RunWorkflowNodeDesigner.module.scss";

const RunWorkflowNodeDesigner = React.memo(function RunWorkflowNodeDesigner({ diagramEngine, node: designerNode }) {
  const {
...
export default RunWorkflowNodeDesigner;

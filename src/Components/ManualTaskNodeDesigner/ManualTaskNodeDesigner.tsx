...
import styles from "./ManualTaskNodeDesigner.module.scss";

const ManualTaskNodeDesigner = React.memo(function ManualTaskNodeDesigner({ diagramEngine, node: designerNode }) {
  const {
...
export default ManualTaskNodeDesigner;

...
export const serviceUrl = {
  ...
  deleteWorkflowSchedule: ({ workflowId, scheduleId }) => `${BASE_URL}/workflow/${workflowId}/schedule/${scheduleId}`,
  ...
  patchWorkflowSchedule: ({ workflowId, scheduleId }) => `${BASE_URL}/workflow/${workflowId}/schedule/${scheduleId}`,
  ...
  postWorkflowSchedule: ({ workflowId }) => `${BASE_URL}/${workflowId}/schedule`,
